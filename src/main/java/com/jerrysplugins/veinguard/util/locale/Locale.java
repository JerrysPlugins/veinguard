package com.jerrysplugins.veinguard.util.locale;
...
public class Locale {
    ...
    public String getMessage(String key, boolean formatting) {
        plugin.getLog().log(Level.DEBUG, "Pushing method getMessage() in Locale.class. For key + '" + key + "'");
    ...
    public String stripColorCodes(String message) {
        plugin.getLog().log(Level.DEBUG, "Pushing method getMessage() in Locale.class. For message + '" + message + "'");
        if (message == null) return "";
        return STRIP_PATTERN.matcher(message).replaceAll("");
    }

    public String translateColorCodes(String message) {
        plugin.getLog().log(Level.DEBUG, "Pushing method translateColorCodes() in Locale.class. For message + '" + message + "'");
