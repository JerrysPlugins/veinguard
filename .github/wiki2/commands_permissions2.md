...
*   **Description:** Displays a leaderboard of players with the highest violation levels or block counts over a specific period.
...
*   **Description:** Manage which blocks are monitored, their thresholds, and their violation weights in real-time.
